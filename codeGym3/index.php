                ...
                <div class="container">
                    <nav>
                        ...
                        <ul class="pull-right" id="main-shopping">
                            <li>
                                <a href="giohang.php?id=<?php echo $num['Masp'];?>"><i class="fa fa-shopping-basket"></i>Giỏ Hàng</a>
                            </li>
                        </ul>
                        <!--end Shopping-->
                    </nav>
                            ...
                            <div class="showitem">
                                <div class="col-md-3 item-product bor">
                                    ...
                                    <div class="hidenitem">
                                        ...
                                        <p><a href="giohang.php?id=<?php echo $rows['Masp'];?>'"><i class="fa fa-shopping-basket"></i></a></p>
                                    </div>
                             </div>
                                     <?php }?>
